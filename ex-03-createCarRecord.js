...
var createCarRecord = function(make, model, year, license){
  //var carStuff = {}
  var carStuffObj = {
    make: make,
    model: model,
  ...
  if (typeof carStuffObj.make === 'undefined' || typeof carStuffObj.model === 'undefined' || typeof carStuffObj.year === 'undefined' || typeof carStuffObj.license === 'undefined') {
    return 'new record must have make, model, year, and license values'
  }

   if(typeof make !== 'string' || typeof model !== 'string' || typeof license !== 'string' ){
